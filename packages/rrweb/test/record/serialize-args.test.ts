...
describe('serializeArg', () => {
  ...
  it('should serialize Float32Array values', async () => {
    ...
    expect(
      serializeArg(float32Array, window, context, defaultDataURLOptions),
  ...
  it('should serialize Float64Array values', async () => {
    ...
    expect(
      serializeArg(float64Array, window, context, defaultDataURLOptions),
    ).toStrictEqual(expected);
  });
  ...
  it('should serialize ArrayBuffer values', async () => {
    ...
    expect(
      serializeArg(arrayBuffer, window, context, defaultDataURLOptions),
    ).toStrictEqual(expected);
  });
  ...
  it('should serialize Uint8Array values', async () => {
    ...
    expect(
      serializeArg(object, window, context, defaultDataURLOptions),
    ).toStrictEqual(expected);
  });
  ...
  it('should serialize DataView values', async () => {
    ...
    expect(
      serializeArg(dataView, window, context, defaultDataURLOptions),
    ).toStrictEqual(expected);
  });
  ...
  it('should leave arrays intact', async () => {
    const array = [1, 2, 3, 4];
    expect(
      serializeArg(array, window, context, defaultDataURLOptions),
    ).toStrictEqual(array);
  });
  ...
  it('should serialize arraybuffer contents', async () => {
    ...
    expect(
      serializeArg(buffer, window, context, defaultDataURLOptions),
    ).toStrictEqual(expected);
  });

  it('should leave null as-is', async () => {
    expect(
      serializeArg(null, window, context, defaultDataURLOptions),
    ).toStrictEqual(null);
  });
  ...
  it('should support indexed variables', async () => {
    ...
    expect(
      serializeArg(webGLProgram, window, context, defaultDataURLOptions),
    ).toStrictEqual({
    ...
    expect(
      serializeArg(webGLProgram2, window, context, defaultDataURLOptions),
    ).toStrictEqual({
      rr_type: 'WebGLProgram',
      index: 1,
    });
  ...
  it('should support indexed variables grouped by context', async () => {
    ...
    expect(
      serializeArg(webGLProgram1, window, context1, defaultDataURLOptions),
    ).toStrictEqual({
      rr_type: 'WebGLProgram',
      index: 0,
    });
    ...
    const webGLProgram2 = new WebGLProgram();
    expect(
      serializeArg(webGLProgram2, window, context2, defaultDataURLOptions),
    ).toStrictEqual({
      rr_type: 'WebGLProgram',
      index: 0,
    });
  ...
  it('should support HTMLImageElements', async () => {
    ...
    expect(
      serializeArg(image, window, context, defaultDataURLOptions),
    ).toStrictEqual({
  ...
  it('should serialize ImageData', async () => {
    ...
    expect(
      serializeArg(imageData, window, context, defaultDataURLOptions),
    ).toStrictEqual({
      rr_type: 'ImageData',
      args: [
        {
  ...
  it.skip('should serialize a blob', async () => {
    ...
    expect(
      await serializeArg(blob, window, context, defaultDataURLOptions),
    ).toStrictEqual({
      rr_type: 'Blob',
...
describe('serializeArg with dataURLOptions', () => {
  ...
  describe.each([
    ...
    'HTMLCanvasElement with $description',
